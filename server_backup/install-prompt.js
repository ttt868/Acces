...
// الحصول على الترجمة حسب لغة الموقع المختارة
function getInstallText() {
  // استخدام لغة الموقع المفضلة (نفس التطبيق)
  const preferredLang = localStorage.getItem('preferredLanguage');
  const userLang = preferredLang ? preferredLang.split('-')[0] : navigator.language.split('-')[0];
