    ...
    private void setNavigationBarBackgroundColor(final String colorPref, Boolean lightNavigationBar) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            if (colorPref != null && !colorPref.isEmpty()) {
                ...
                // Ensure system draws bar backgrounds
                ...
                // Set button/icon color: light=true means dark icons (for light backgrounds)
                if (Build.VERSION.SDK_INT >= 30) {
                    ...
                    // API 26-29: Use SYSTEM_UI_FLAG_LIGHT_NAVIGATION_BAR
                    int uiOptions = window.getDecorView().getSystemUiVisibility();
                    if (lightNavigationBar) {
